import 'node:fs';
import { e as appendForwardSlash, j as joinPaths, t as trimSlashes, s as slash, p as prependForwardSlash, r as removeTrailingForwardSlash, f as collapseDuplicateSlashes } from './chunks/astro/assets-service_kXLA1hwI.mjs';
import { serialize, parse } from 'cookie';
import { A as AstroError, R as ResponseSentError, l as MiddlewareNoDataOrNextCalled, n as MiddlewareNotAResponse, G as GetStaticPathsRequired, o as InvalidGetStaticPathsReturn, p as InvalidGetStaticPathsEntry, q as GetStaticPathsExpectedParams, t as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, N as NoMatchingStaticPathFound, u as PrerenderDynamicEndpointPathCollide, v as LocalsNotAnObject, w as ASTRO_VERSION, C as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, x as renderEndpoint, y as ReservedSlotName, z as renderSlotToString, B as renderJSX, D as chunkToString, F as CantRenderPage, H as renderPage$1 } from './chunks/astro_JoLp8WV8.mjs';
import { l as levels, g as getEventPrefix, L as Logger, A as AstroIntegrationLogger, manifest } from './manifest_X9ey3AqY.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
...
const _page0  = () => import('./chunks/generic_Ux4sSNUK.mjs');
const _page1  = () => import('./chunks/_id__8CdhudWX.mjs');
const _page2  = () => import('./chunks/index_icg9wdiR.mjs');
const _page3  = () => import('./chunks/items_cZCg9P0Z.mjs');const pageMap = new Map([["node_modules/astro/dist/assets/endpoint/generic.js", _page0],["src/pages/items/[id].astro", _page1],["src/pages/index.astro", _page2],["src/pages/items.astro", _page3]]);
